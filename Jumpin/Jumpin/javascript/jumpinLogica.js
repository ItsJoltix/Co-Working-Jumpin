...
// Comment the level you do not want
// Level 5
// Holes
/*
boxes[0].classList.add("hole");
boxes[4].classList.add("hole");
boxes[12].classList.add("hole");
boxes[20].classList.add("hole");
boxes[24].classList.add("hole");
// Leli leafs
boxes[6].classList.add("leli");
boxes[10].classList.add("leli");
boxes[15].classList.add("leli");
// Frog
boxes[20].classList.add("frog");
boxes[2].classList.add("frog");
*/
// Level 30
// Holes
boxes[0].classList.add("hole");
...
boxes[24].classList.add("hole");
// Leli leafs
boxes[14].classList.add("leli");
// Frog
boxes[16].classList.add("frog");
boxes[22].classList.add("frog");
// Reiger
boxes[1].classList.add('reigerBottomTailPosition');
boxes[1].classList.add('reigerTail');
boxes[6].classList.add('reigerBottomHeadPosition');
boxes[6].classList.add('reigerHead');

boxes[9].classList.add('reigerLeftTailPosition');
boxes[9].classList.add('reigerTail');
boxes[8].classList.add('reigerLeftHeadPosition');
boxes[8].classList.add('reigerHead');
...
function checkWon(){
    let frogsInHole = 0;
    boxes.forEach(box => {
        if(box.classList.contains('hole') &&
            box.classList.contains('frog')){
            frogsInHole++;
        }
    });
